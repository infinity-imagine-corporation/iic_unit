...
echo PHP_EOL.'Integrated test for '.$title.PHP_EOL;
...
echo 	PHP_EOL.
		'Time: '.$this->benchmark->elapsed_time('start_integrate', 'end_integrate').' seconds, '.
		'Memory: '.$this->benchmark->memory_usage().
		PHP_EOL.
		PHP_EOL;

echo $test_result.' ('.$total_test.' ';
echo ($total_test > 1) ?	'tests, ' : 'test, ';
